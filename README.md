...
In this tutorial I will guide you through the steps to create resource group in Azure, observe various types of network traffic using Wireshark, and understand the behavior of different protocols. <br />
